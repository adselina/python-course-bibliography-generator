...
class TestGOST:
    ...
    def test_article(self, article_model_fixture: ArticleModel) -> None:
        """
        Тестирование форматирования статьи.

        :param ArticleModel article_model_fixture: Фикстура модели статьи
        :return:
        """

        model = GOSTArticle(article_model_fixture)
    ...
    def test_dissertation(self, dissertation_model_fixture: DissertationModel) -> None:
        ...
        assert (
            model.formatted
            == "Иванов И.М. Наука как искусство: дис. д-р. ... экон.. 01.01.01. СПб., 2020. С. 199."
        )
    ...
    def test_citation_formatter(
        ...
        models = [
            ...
            GOSTArticle(article_model_fixture),
