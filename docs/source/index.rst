...
5. Для запуска приложения выполните:
    ...
    По умолчанию программа выполняет форматирование источников по стандарту ГОСТ с помощью команды:
        .. code-block:: console

            make gost

    Если необходимо выполнить форматирование по стандарту APA, в консоли необходимо запустить следующую команду:
        .. code-block:: console
